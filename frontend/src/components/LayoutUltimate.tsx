...
const LayoutUltimate = () => {
  ...
  return (
    <div className="flex h-screen bg-gray-900">
      {/* Sidebar Dark */}
      <aside className={`${collapsed ? 'w-20' : 'w-72'} bg-gray-900 shadow-2xl transition-all duration-300 overflow-y-auto relative border-r border-gray-800 flex flex-col`}>
        {/* Logo Area */}
        ...
        {/* Untuk collapsed mode - logo kecil di footer */}
        {collapsed && (
          <div className="p-3 border-t border-gray-800 mt-auto flex justify-center">
            <div className="text-center">
              <Crown className="h-4 w-4 text-blue-400 mx-auto" />
              <p className="text-[8px] text-gray-500 mt-1">SALSADILA</p>
            </div>
          </div>
        )}
      </aside>
      ...
      <main className="flex-1 overflow-auto bg-gray-900">
        ...
        <div className="sticky top-0 z-10 bg-gray-900/95 backdrop-blur-md p-4 border-b border-gray-800 flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-sm font-semibold text-white">Welcome back, {user?.name || 'Super Admin'}</h2>
